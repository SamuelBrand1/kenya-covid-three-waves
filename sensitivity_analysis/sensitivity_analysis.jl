...
variable_title_name = Dict("ct_min1" => "% mobility of lower SES mid-April 2020",
                            ...
                            "p_test₁" => "Per day rate tested if positive (lower SES)",
                            "p_test₂" => "Per day rate tested if positive (higher SES)",
                            "p_choose1" => "Prop. tests among lower SES",
                            "P_eff" => "Prop. population among lower SES",
                            "schooleffect" => "R(t) multiplier when schools shut",
                            ...
                            "χ_boost" => "Change in bias for pos. PCR (new variants)",
